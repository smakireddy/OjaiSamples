...
public class OJAI_013_ReadYourOwnWrite {
  ...
  public static void main(String[] args) {
    ...
    final DocumentStore storeNode1 = connectionNode1.getStore("/user/som/demo_table");
    ...
    // Get an instance of OJAI DocumentStore
    final DocumentStore storeNode2 = connectionNode2.getStore("/user/som/demo_table");
